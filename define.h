...
#define DINGOS_PARAMS_FILE "Dingos.cfg"
#define AI_CONTROL_PARAMS_FILE "AIControl.cfg"
...
#define echologger_serial_name "/dev/ttyUSB0"
#define ublox_serial_name "/dev/ttyUSB1"

#define ground_gps_ahrs_serial_name "/dev/ttyUSB3"
